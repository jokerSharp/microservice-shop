...
public class ProductReviewsRestControllerTest {
    ...
    void findProductReviewsByProductId_ReturnsProductReviews() {
        ...
        StepVerifier.create(this.controller.findProductReviewsByProductId(1))
                // then
                .expectNext(
                        new ProductReview(UUID.fromString("bd7779c2-cb05-11ee-b5f3-df46a1249898"), 1,
                                1, "First review", "user-1"),
                        new ProductReview(UUID.fromString("be424abc-cb05-11ee-ab16-2b747e61f570"), 1,
                                3, "Second review", "user-2"),
                        new ProductReview(UUID.fromString("be77f95a-cb05-11ee-91a3-1bdc94fa9de4"), 1,
                                5, "Third review", "user-3"))
                .verifyComplete();
    ...
    void createProductReview_ReturnsCreatedProductReview() {
        ...
        doReturn(Mono.just(new ProductReview(UUID.fromString("5a9ba234-cbd6-11ee-acab-5748ca6678b9"), 1, 4,
                "Average", "5f1d5cf8-cbd6-11ee-9579-cf24d050b47c")))
                .when(this.productReviewsService)
                .createProductReview(1, 4, "Average", "5f1d5cf8-cbd6-11ee-9579-cf24d050b47c");
        ...
        StepVerifier.create(this.controller.createProductReview(
                        ...
                        Mono.just(new NewProductReviewPayload(1, 4, "Average")),
                        UriComponentsBuilder.fromUriString("http://localhost")))
                // then
                .expectNext(ResponseEntity
                        .created(URI.create("http://localhost/feedback-api/product-reviews/5a9ba234-cbd6-11ee-acab-5748ca6678b9"))
