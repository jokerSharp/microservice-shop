...
public class FavouriteProductsRestControllerTest {
    ...
    void addProductToFavourites_ReturnsCreatedFavouriteProduct() {
        ...
        doReturn(Mono.just(new FavouriteProduct(UUID.fromString("fe87eef6-cbd7-11ee-aeb6-275dac91de02"), 1,
                "5f1d5cf8-cbd6-11ee-9579-cf24d050b47c")))
                .when(this.favouriteProductsService)
                .addProductToFavourites(1, "5f1d5cf8-cbd6-11ee-9579-cf24d050b47c");

        // when
        StepVerifier.create(this.controller
                        .addProductToFavourite(Mono.just(new JwtAuthenticationToken(Jwt.withTokenValue("e30.e30")
                                        .headers(headers -> headers.put("foo", "bar"))
                                        .claim("sub", "5f1d5cf8-cbd6-11ee-9579-cf24d050b47c").build())),
                ...
                .expectNext(ResponseEntity
                        .created(URI.create("http://localhost/feedback-api/favourite-products/fe87eef6-cbd7-11ee-aeb6-275dac91de02"))
    ...
    void removeProductFromFavourites_ReturnsNoContent() {
        ...
        // when
        StepVerifier.create(this.controller.removeProductFromFavourites(Mono
                        .just(new JwtAuthenticationToken(Jwt.withTokenValue("e30.e30")
                                .headers(headers -> headers.put("foo", "bar"))
                                .claim("sub", "5f1d5cf8-cbd6-11ee-9579-cf24d050b47c").build())), 1))
                // then
